"""Independent, read-only, fail-closed audit of committed v2 Phase 5 evidence.
...
PROTECTED = (
    ("2aae07a3d12907d1869eb603e6ac1a6fb8d851dd", "TradingSystemLab/results/baseline_v2"),
    ("9206e2f2ca9a6524ddf78ba473b9b882938aefc6", "TradingSystemLab/results/optimization_v2"),
    ("ff0db54b35544086f4265c303b1018d57d3849e7", "TradingSystemLab/results/phase3_candidate_freeze"),
    ("d89d0f1f7ba3259e0f08e43a0832bd16f4d15f6b", "TradingSystemLab/results/robustness_v2"),
    ("0b0027665fdcc0f847b6b9a10cb5928fcfd2d553", "TradingSystemLab/results/walk_forward_v2"),
    (PHASE5_MERGE, "TradingSystemLab/results/true_oos_v2"),
)
...
def audit(root: Path = OUTPUT_ROOT, *, check_git_trees: bool = True) -> dict[str, Any]:
    ...
    req(manifest["status"] == "PHASE_5_TRUE_OOS_VALIDATION_COMPLETE", "PHASE5_STATUS_INVALID")
    ...
    for item in candidates:
        ...
        grouping = (("yearly_report.csv", "year", exits.dt.year, sorted(exits.dt.year.unique())),
                    ("quarterly_report.csv", "quarter", exit_quarters,
                     sorted(exit_quarters.unique())),
    ...
    expected_classes = {f"{s}/{tf}": "BORDERLINE" for s, tf in STUDIES}
    ...
    return {"status": "V2_FIVE_STAGE_CYCLE_CLOSEOUT_COMPLETE", "classifications": classes}
