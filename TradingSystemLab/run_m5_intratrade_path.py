"""Run the causal M5 intratrade-path diagnostic."""
from __future__ import annotations
import argparse
import json
from pathlib import Path
from .timeframe_analysis.m5_intratrade_path import DATA, OUTPUT, VALIDATION, run
...
def main() -> None:
    ...
    print(json.dumps(run(args.validation, args.data, args.output, market), indent=2, sort_keys=True))
