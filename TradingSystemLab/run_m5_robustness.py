"""Run deterministic M5 candidate robustness validation."""
from __future__ import annotations
import argparse
import json
from pathlib import Path
from .timeframe_analysis.m5_robustness import DATA, OPTIMIZATION, OUTPUT, VALIDATION, run
...
def main() -> None:
    ...
    if supplied and (args.usd_data is None or args.cny_data is None): parser.error("--usd-data and --cny-data must be supplied together")
