"""Development-only Phase 3 robustness for the four frozen v3 candidates.
...
from ..perpetual_v3_baseline import (DATA_ROOT, FROZEN_TICK_SIZE, INSTRUMENTS,
                           TRUE_OOS_START, load_development)
from ..core.unified_metrics import concentration, finite, stats
from ..perpetual_v3_baseline import verify_strategy_identity
...
from ..perpetual_v3_phase2b_t3 import _execute as execute_t3

REGISTRY_PATH = Path("TradingSystemLab/results/perpetual_v3/phase3_candidate_freeze/candidate_registry.json")
PHASE2_ROOT = Path("TradingSystemLab/results/perpetual_v3/optimization")
OUTPUT_ROOT = Path("TradingSystemLab/results/perpetual_v3/robustness")
FREEZE_REFERENCE_COMMIT = "f123f1468c6b5f1f0719154aba73d4635e6de0ea"
STUDIES = (("T2", "M30"), ("T2", "H1"), ("T3", "M30"), ("T3", "H1"))
EXPECTED_IDS = {
    ("T2", "M30"): ("T2_M30_candidate_v3", "608dc87d09f10aa0e03026ebb525f6b8ec865060c7890cee08fa0c7ed14cf86b"),
    ("T2", "H1"): ("T2_H1_candidate_v3", "608dc87d09f10aa0e03026ebb525f6b8ec865060c7890cee08fa0c7ed14cf86b"),
    ("T3", "M30"): ("T3_M30_candidate_v3", "d6feb972db575bf6e66ac901be95fe079dccc82d9e2c3e880d17faeae8d1adf9"),
    ("T3", "H1"): ("T3_H1_candidate_v3", "4e73cdb77246cb07b5953160b9fc0ab36bfd4bd6d9a7f7faaae7e6e392ee340a"),
}
...
def run(data_root: Path = DATA_ROOT, output: Path = OUTPUT_ROOT,
    ...
    verify_strategy_identity()  # must precede the first market-data read
    ...
    for item in registry:
        ...
        manifest = {"generation": "v3_perpetual", "lifecycle_phase": "Robustness", "phase": "PHASE_3_ROBUSTNESS", "methodological_source": "original H1 Phase 3.3",
                    ...
                    "full_execution_parameters": asdict(replace(
                        T2Parameters() if strategy == "T2" else T3Parameters(), **item["parameters"])),
                    "frozen_strategy_source_hash": item["frozen_strategy_source_hash"],
                    "freeze_reference_commit": FREEZE_REFERENCE_COMMIT, "phase2_reference_commit": "272eabd5a4261a18a763356964b82b4b5b5673ea",
                    ...
                    "true_oos_status": "BLOCKED_NOT_READ_NOT_EXECUTED", "true_oos_blocked": True, "normalized_research_tick": FROZEN_TICK_SIZE,
    ...
    root_manifest = {"generation": "v3_perpetual", "lifecycle_phase": "Robustness", "phase": "PHASE_3_ROBUSTNESS", "methodological_source": "original H1 Phase 3.3",
        "status": "PENDING_AUDIT", "candidate_count": 4, "freeze_reference_commit": FREEZE_REFERENCE_COMMIT, "phase2_reference_commit": "272eabd5a4261a18a763356964b82b4b5b5673ea",
        ...
        "development_period": list(DEVELOPMENT_PERIOD), "true_oos_start": "2025-01-01",
        "true_oos_status": "BLOCKED_NOT_READ_NOT_EXECUTED", "true_oos_blocked": True, "C1_only": True, "normalized_research_tick": FROZEN_TICK_SIZE,
        ...
        "reproducibility_note": "A second full execution produced byte-identical pre-audit research artifacts.",
    ...
    lines = ["# TradingSystemLab v3 perpetual — Phase 3 Final Robustness Report", "",
