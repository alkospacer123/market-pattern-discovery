"""Run the read-only M5 entry-quality diagnostic."""
...
from .timeframe_analysis.m5_entry_quality import DATA, OPTIMIZATION, OUTPUT, VALIDATION, run
...
def main() -> None:
    ...
    print(json.dumps(run(args.validation, args.optimization, args.data, args.output, market),
